...
type GolangMetric struct {
	...
	CpuUsedRate  int64 `protobuf:"varint,8,opt,name=cpuUsedRate,proto3" json:"cpuUsedRate,omitempty"`
	MemUsedRate  int64 `protobuf:"varint,9,opt,name=memUsedRate,proto3" json:"memUsedRate,omitempty"`
}
...
func (x *GolangMetric) GetCpuUsedRate() int64 {
	if x != nil {
...
func (x *GolangMetric) GetMemUsedRate() int64 {
	if x != nil {
...
var file_language_agent_GolangMetric_proto_rawDesc = []byte{
	...
	0x75, 0x55, 0x73, 0x65, 0x64, 0x52, 0x61, 0x74, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x03, 0x52, 0x0b, 0x6d, 0x65, 0x6d, 0x55, 0x73, 0x65, 0x64, 0x52, 0x61, 0x74, 0x65, 0x32, 0x68,
